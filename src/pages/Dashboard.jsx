        ...
        <main className="flex flex-col items-center justify-between bg-gradient-to-b from-lp3i-400 via-lp3i-200 to-lp3i-400 md:h-screen pt-5 pb-2">
          ...
          <div className='flex flex-col items-center justify-center gap-5 md:gap-8 max-w-3xl w-full mx-auto px-5 h-screen md:h-full'>
            ...
            <section className='flex flex-col md:flex-row items-center gap-4'>
              {
                validate ? (
                  <a href='https://wa.me?phone=6281286501015&text=Kirim%20pesan%20perintah%20ini%20untuk%20konfirmasi%20pendaftaran%20:confirmregistration:' target='_blank' className="text-white bg-emerald-500 hover:bg-emerald-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 space-x-2">
